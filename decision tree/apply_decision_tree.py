...
train_auc = roc_auc_score(train['high_income'], pre1)
pre2 = clf.predict(test[columns])
test_auc = roc_auc_score(test['high_income'], pre2)
...
clf2 = DecisionTreeClassifier(random_state=1, max_depth=7, min_samples_split=13)
clf2.fit(train[columns], train['high_income'])
pre1 = clf2.predict(train[columns])
train_auc = roc_auc_score(train['high_income'], pre1)
