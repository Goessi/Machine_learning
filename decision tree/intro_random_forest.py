...
rounded_mean = numpy.round(mean)
print(roc_auc_score(test['high_income'], rounded_mean))
...
a = [sum(i) for i in zip(*predictions)]
a = [i/10 for i in a]
a = numpy.round(a)
...
def find_best_column(data, target_name, columns):
    information_gains = []
    set_cols = numpy.random.choice(columns, 2)
...
print(roc_auc_score(train['high_income'], pre1))
print(roc_auc_score(test['high_income'], pre2))
